...
const revealTargets = document.querySelectorAll<HTMLElement>(".item-package");
const revealScrollContainer = document.querySelector<HTMLElement>(".container.scrollable");
